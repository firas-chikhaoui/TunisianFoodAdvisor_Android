package com.tunisianfood_advisor.Utils;
...
import com.tunisianfood_advisor.activity.ProfileActivity;
import com.tunisianfood_advisor.activity.SearchActivity;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.action_favorites:
                        Intent intent3 = new Intent(context, FavoritePlacesActivity.class); //ACTIVITY_NUM = 2
