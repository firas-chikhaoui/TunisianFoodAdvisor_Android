...
import com.tunisianfood_advisor.adapter.ExtrasAdapter;
...
public class ItemDetailsActivity extends AppCompatActivity implements ExtrasAdapter.OnExtraClickListener {
    ...
    private static String[] array_imgs = new String[] {
            "http://fleurdelysdoll.com/9577-45335-large_default/plateau-et-repas-cuisine-miniature-barbie-blythe-pullip-mymeadows-gigi-lati-yellow-pukifee-bjd-diorama-dollhouse-16.jpg",
            "http://fleurdelysdoll.com/9577-45335-large_default/plateau-et-repas-cuisine-miniature-barbie-blythe-pullip-mymeadows-gigi-lati-yellow-pukifee-bjd-diorama-dollhouse-16.jpg",
            "http://fleurdelysdoll.com/9577-45335-large_default/plateau-et-repas-cuisine-miniature-barbie-blythe-pullip-mymeadows-gigi-lati-yellow-pukifee-bjd-diorama-dollhouse-16.jpg"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        prodname = i.getStringExtra("ARG_PROD_NAME");
        prodprice = i.getStringExtra("ARG_PROD_PRIX");
        proddescription = i.getStringExtra("ARG_PROD_DESC");
        ...
        item_price.setText(prodprice);

        item_description = (TextView) findViewById(R.id.item_description);
        item_description.setText(proddescription);
        ...
        mOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(getApplicationContext(), "Vous n'avez pas installé WhatsApp", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
